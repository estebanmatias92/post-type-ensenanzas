...
if ( !class_exists( 'Ensenanzas_Get_Templates' ) ) :

    /**
     * Ensenanzas_Get_Templates
     *
     ...
     */
    class Ensenanzas_Get_Templates extends Post_Type_Ensenanzas
    {
        ...
        private function get_template_hierarchy( $template )
        {
            ...
            if ( $theme_file = locate_template( array( $template_post_type ) ) ) {
                ...
                $file = PTE_PLUGIN_ROOT . 'views/templates/' . $template;
            }
